...
As the creators and maintainers of this project, we want to ensure that `@basestacks/datagrid` lives and continues to grow and evolve. We would like to encourage everyone to help and support this library by contributing.

## Code contributions

Here is a quick guide to doing code contributions to the library.

1. Fork and clone the repo to your local machine `git clone https://github.com/basestacks/datagrid`
...
By contributing your code to the `@basestacks/datagrid` GitHub repository, you agree to license your contribution under the MIT license.
